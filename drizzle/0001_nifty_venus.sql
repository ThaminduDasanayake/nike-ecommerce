...
ALTER TABLE "guest" RENAME COLUMN "sessionToken" TO "session_token";--> statement-breakpoint
ALTER TABLE "guest" RENAME COLUMN "createdAt" TO "created_at";--> statement-breakpoint
ALTER TABLE "guest" RENAME COLUMN "expiresAt" TO "expires_at";--> statement-breakpoint
...
ALTER TABLE "guest" DROP CONSTRAINT "guest_sessionToken_unique";--> statement-breakpoint
...
ALTER TABLE "guest" ADD CONSTRAINT "guest_session_token_unique" UNIQUE("session_token");