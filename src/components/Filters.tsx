...
export default function Filters() {
  ...
  const Group = ({
    ...
    <div className="border-light-300 border-b py-4">
      <button
        className="text-body-medium text-dark-900 flex w-full items-center justify-between"
  ...
  return (
    <>
      <div className="mb-4 flex items-center justify-between md:hidden">
        <button
          className="border-light-300 text-body-medium rounded-md border px-3 py-2"
              ...
              return (
                <li key={g} className="flex items-center gap-2">
                  <input
                    id={`gender-${g}`}
                    type="checkbox"
                    className="accent-dark-900 h-4 w-4"
                    checked={checked}
      ...
      {open && (
        <div className="fixed inset-0 z-50 md:hidden" role="dialog" aria-modal="true">
          ...
          />
          <div className="bg-light-100 absolute inset-y-0 left-0 w-80 max-w-[80%] overflow-auto p-4 shadow-xl">
            <div className="mb-2 flex items-center justify-between">
